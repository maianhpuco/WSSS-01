...
# For dataset only 
quantizing_luad: 
	main_quantizing.py --configs configs/quantizing_luad.yaml --k_start 0 --k_end 1 --epoch 100 
...
test_sillymodel_luad:
	main_train_silly_model.py --configs configs/sillymodel_luad.yaml --check_point $(VER24_CKPT) 